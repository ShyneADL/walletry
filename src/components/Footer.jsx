    ...
    <footer className='xl:px-20 px-[20px] pb-[32px] lg:pt-[113px] pt-[70px] flex flex-col items-start gap-[32px] bg-darkBlue w-full relative'>
      ...
      <div className='flex items-center justify-between w-full'>
        ...
        <div className='flex items-center md:gap-5 gap-3'>
          <p className='font-inter font-normal md:text-[16px] text-[14px] leading-[24px] text-[#5D6588] cursor-pointer md:w-[140px] w-[70px]'>Terms of Service</p>
          <div className='h-6 w-[1px] bg-[#5D6588]'/>
          <p className='font-inter font-normal md:text-[16px] text-[14px] leading-[24px] text-[#5D6588] cursor-pointer md:w-[120px] w-[70px]'>Privacy Policy</p>
        </div>
      </div>
