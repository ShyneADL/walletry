...
const Onboarding = () => {
  return (
    <section className='py-[70px] md:px-[80px] px-[20px] bg-darkBlue flex flex-col items-center gap-[86px] w-full'>
      ...
      <div className='flex lg:flex-row flex-col-reverse items-center lg:gap-[108px] gap-[72px] lg:mb-[110px] mb-[50px]'>
        ...
        <div className='flex flex-col items-start gap-[35px] bg-white rounded-[24px] lg:py-[85px] py-[52px] lg:pl-[73px] pl-[30px] lg:pr-[155px] pr-[30px]'>
