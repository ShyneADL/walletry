...
const Onboarding = () => {
  return (
    <section className='py-[70px] md:px-[80px] px-[20px] bg-darkBlue flex flex-col items-center gap-[86px] w-full'>
      ...
      <div className='flex md:flex-row flex-col-reverse items-center md:gap-[108px] gap-[72px] md:mb-[110px] mb-[50px]'>
        <ul className='flex md:flex-col items-center md:gap-[26px] md:flex-nowrap flex-wrap gap-[12px] justify-center'>
        ...
        <div className='flex flex-col items-start gap-[35px] bg-white rounded-[24px] md:py-[85px] py-[52px] md:pl-[73px] pl-[30px] md:pr-[155px] pr-[30px]'>
