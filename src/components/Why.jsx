  ...
  return (
    <section className='px-[72px] py-[110px] flex items-center gap-[133.86px] bg-darkBlue'>
      ...
      <div className='flex flex-col items-start gap-[22px]'>
        <h3 className='font-sora font-extrabold xl:text-[40px] md:text-[36px] xl:leading-[52px] md:leading-[44px] tracking-[-1.2px] text-white w-[578px]'>Top blockchains build on Walletry.</h3>
