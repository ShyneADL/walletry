...
const FinalSect = () => {
  return (
    <section className='lg:px-20 px-[20px] lg:pt-[140px] py-[60px] pb-[70px] bg-white flex flex-col items-start lg:gap-[70px] gap-[40px] w-full relative'>
      <div className='flex lg:flex-row flex-col items-center lg:gap-[122px] gap-[0px] lg:pl-[26px] pl-[0px] lg:pr-[52px] pr-[0px] '>
        ...
        <img src={device} className='md:w-[450px] w-[240px]' />
      </div>
      <div className='flex items-center lg:flex-nowrap flex-wrap lg:gap-[73px] gap-[25px] rounded-[16px] py-[38px] lg:px-[125px] px-[38px] mt-[23px] bg-darkBlue w-full'>
